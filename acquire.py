...
def all_groceries_csv():
    '''
    This function stores the merged stores data locally as a .csv
    '''
    sales_stores_items = new_groceries()
    return sales_stores_items.to_csv('sales_stores_items.csv')
